	...
	<body>
		...
		<div id="content">
			...
			<div id="right">
				<div class="box">
					<div class="title">
						<h5><?php echo $subject->name; ?> > 上传文件</h5>
					</div>
					<form id="docForm" name="docForm" action="<?php echo site_url('admin/document/documentAdd')?>" method="post" enctype="multipart/form-data">
					...
					<div class="form">
						<div class="fields">
							...
							<div class="field">
								...
								<div class="input">
									<textarea name="brief" rows=8 cols=80 ></textarea>
								</div>
							</div>						
							<div class="field">
