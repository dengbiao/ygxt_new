                ...
                <div class="table">
                    ...
                    <table>
                        ...
                        <?php if($salary['status'] == 0) {?>
                                ...
                                <td><input type="text" value="<?=$salary['remark']?>" disabled="true"/></td>
                        <?php }else {?> 
                                <td><input type="text" value="<?=$salary['salary']?>"/></td>
                                <td><input type="text" value="<?=$salary['remark']?>"/></td>
                        <?php }?> 
                                <td>										
                        <?php if($salary['status'] != 0) {?>
                                    <a href="">不予考核</a>
                    ...
                    <!-- end pagination -->
                        <div class="submit">
                            ...
                            <input type="submit" value="提交数据" onclick="return alert('确认提交吗？');">
                        </div>
                    </form>
                </div>
            </div>
