		...
		<div id="content">
			...
			<div id="right">
				<div class="box">
					...
					<form id="articleForm" name="articleForm" action="<?php echo site_url('admin/article/articleAdd')?>" method="post">
					<input type="hidden" name="pid" value="<?php echo $subject->parentID;?>">
					<input type="hidden" name="sid" value="<?php echo $subject->id;?>">
					<div>
						<center><div>文章标题：<input name="title" style="width:300px;height:21px" /></div><br/>
						<div>
